...
import MenuOpe from './MenuOpe'
	...
	export default {
        ...
        mounted(){
            ...
            if (id > 0)
                axios.get('/admin/subcarpetas/'+id+'/edit')
                    .then(res => {
                        
                        this.carpetas = res.data.carpetas;
                        this.subcarpeta = res.data.subcarpeta;
                        this.show = true;
                    })
                    .catch(err => {
    	...
    	methods:{
            submit() {
                ...
                //console.log("Edit user (submit):"+this.subcarpeta.id);
                this.enviando = true;

                var url = "/admin/subcarpetas/"+this.subcarpeta.id;
                var metodo = "put";
                    ...
                    if (result){
                        axios({
                            ...
                            .then(response => {
                                ...
                                this.subcarpeta = response.data.subcarpeta;
                                this.enviando = false;
                            })
                            .catch(err => {
