...
import MenuOpe from './MenuOpe'
	...
	export default {
        ...
        mounted(){
            ...
            axios.get('/mto/transferencias/create')
                .then(res => {
    	...
    	methods:{
            submit() {
                ...
                var url = "/mto/transferencias";

                this.$validator.validateAll().then((result) => {
                    if (result){
                        //console.log(result);
                        axios.post(url, this.transferencia)
                            .then(response => {
                                this.$router.push({ name: 'transferencia.edit', params: { id: response.data.transferencia.id } })
                                this.enviando = false;
