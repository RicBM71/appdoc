  ...
  export default {
    ...
    methods:{
        ...
        filtrar(){
            ...
            this.show_loading = true;
            axios.post('mto/transferencias/filtrar',
                    {
        ...
        openDialog (item){
            ...
            this.index = this.transferencias.indexOf(item)
        },
        destroyReg () {
            this.dialog = false;

            axios.post('/mto/transferencias/'+this.transferencia_id,{_method: 'delete'})
                .then(response => {

                this.transferencias.splice(this.index, 1)
        ...
        editItem (id) {
            ...
            if (this.isAdmin)
                this.$router.push({ name: 'transferencia.edit', params: { id: id } })
            else
                this.$router.push({ name: 'transferencia.show', params: { id: id } })
        },
    }
  }
</script>
